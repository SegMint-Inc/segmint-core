...
contract SegMintVaultManagerTest is Base {
    ...
    function test_UnlockAssets_ERC721() public lockERC721 {
        ...
        assertEq(erc721.ownerOf(vaultAssets[0].tokenId), users.alice);
    }
    ...
    function test_UnlockAssets_ERC1155() public lockERC1155 {
        ...
        assertEq(erc1155.balanceOf(users.alice, vaultAssets[0].tokenId), vaultAssets[0].amount);
    }
    ...
    function test_UnlockAssets_Mixed() public lockMixed {
        ...
        assertEq(updatedBalance, initialBalance + vaultAssets[0].amount);
        assertEq(erc721.ownerOf(vaultAssets[1].tokenId), users.alice);
        assertEq(erc1155.balanceOf(users.alice, vaultAssets[2].tokenId), vaultAssets[2].amount);
    }
